...
add wave -noupdate -expand -group CONV /vexp_tb/dut/BF16_FRACTION_CONVERTER/bf16_in
add wave -noupdate -expand -group CONV /vexp_tb/dut/BF16_FRACTION_CONVERTER/int_u32
add wave -noupdate -expand -group CONV /vexp_tb/dut/BF16_FRACTION_CONVERTER/frac_bf16
...
WaveRestoreCursors {{Cursor 1} {319987 ps} 0}
...
update
WaveRestoreZoom {250816 ps} {489692 ps}
