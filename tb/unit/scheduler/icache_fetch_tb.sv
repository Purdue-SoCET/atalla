        ...
        if (!nRST) begin
            ...
            if (mem_cnt == 0) begin
                ...
                if (cif.iREN) begin
                    ...
                    if (cif.iaddr == 32'h00)
                        // Contains: Addr 0x3C (lower 32b) | Addr 0x28 (160b) | Addr 0x14 (160b) | Addr 0x00 (160b)
                        mem_data_reg <= 512'h6400012a_00000000310000000031000000003107810081a3_0000000031000000003100000000310026800116_0000000031000000003100000000310026800096;
                        
                    else if (cif.iaddr == 32'h40)
                        // Contains: Addr 0x78 (lower 64b) | Addr 0x64 (160b) | Addr 0x50 (160b) | Addr 0x3C (upper 128b)
                        mem_data_reg <= 512'h00003100660001aa_0000000031000000003100000000310000800196_0000000031000000003100000000310000000032_00000000310000000031000000003100;
                        
                    else if (cif.iaddr == 32'h80)
                        // Contains: Zero Pad (96b) | Addr 0xA0 (160b) | Addr 0x8C (160b) | Addr 0x78 (upper 96b)
                        mem_data_reg <= 512'h000000000000000000000000_0000000031000000003100000000310000000032_00000000310000000031000000003100680000aa_000000003100000000310000;
                end
            end 
