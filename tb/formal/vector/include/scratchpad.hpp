...
class scratchpad {
    ...
    public:
        ...
        std::queue<int> read_idx_sp1;
        std::queue<int> read_idx_sp;
        int cycle_count = 0;
        //input
        ...
        Eigen::Matrix<Eigen::bfloat16, 32, 1> wdata_sp1; 
        //output
        uint8_t valid_out_sp1;
        Eigen::Matrix<Eigen::bfloat16, 32, 1> rdata_sp1;
        ...
        Eigen::Matrix<Eigen::bfloat16, 32, 1> wdata_sp2; 
        //output
        uint8_t valid_out_sp2;
        Eigen::Matrix<Eigen::bfloat16, 32, 1> rdata_sp2;
