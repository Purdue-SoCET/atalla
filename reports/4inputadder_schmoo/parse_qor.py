...
if __name__ == '__main__':
    add_rows = collect_data('sysarr_4_input_fp_adder_norounding_noprecision')

    with open('qor_summary_sysarr_4_input_fp_adder.md', 'w') as f:
        f.write('# QoR Summary\n\n')
        write_table(f, 'sysarr_4_input_fp_adder', add_rows)

    print(f'Done — wrote qor_summary_sysarr_4_input_fp_adder.md ({len(add_rows)} sysarr_4_input_fp_adder rows')