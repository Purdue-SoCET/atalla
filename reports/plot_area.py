...
if __name__ == '__main__':
    data = collect_data('sysarr_4_input_fp_adder_norounding_noprecision')
    plot_area(data, 'sysarr_4_input_fp_adder — Total Area vs Clock Speed', 'sysarr_4_input_fp_adder_area.png')
    plot_power(data, 'sysarr_4_input_fp_adder — Total Power vs Clock Speed', 'sysarr_4_input_fp_adder_power.png')