...
FSIM_ROOT = THIS_DIR.parents[1]
if str(FSIM_ROOT) not in sys.path:
    sys.path.insert(0, str(FSIM_ROOT))
...
if __name__ == "__main__":
    ...
    demo_asm = """
        ...
        # mask1 = 0x0000000F  (lanes 0..3)
        addi.s  $4, $0, 15
        mv.stm  1, $4

        # mask2 = 0xFFFFFFF0  (lanes 4..31)
        addi.s  $5, $0, -16
        mv.stm  2, $5

        # ---------------- preload all rows ----------------
        vreg.ld  $10, $3, 4, 4, 0, 1, 0
        vreg.ld  $11, $3, 4, 4, 0, 1, 1
        sub.vv   $10, $10, $10, 2, 0 
        vreg.ld  $12, $3, 4, 4, 0, 1, 2
        sub.vv   $11, $11, $11, 2, 0
        vreg.ld  $13, $3, 4, 4, 0, 1, 3
        sub.vv   $12, $12, $12, 2, 0
        sub.vv   $13, $13, $13, 2, 0
        ...
        # ---------------- rsum for all rows (broadcast) ----------------
        rsum.vi  $50, $30, 64, 1
        rsum.vi  $51, $31, 64, 1
        rsum.vi  $52, $32, 64, 1
        rsum.vi  $53, $33, 64, 1

        # move sum lane0 -> scalar
        vmov.vts $24, $50, 0
        vmov.vts $25, $51, 0
        vmov.vts $26, $52, 0
        vmov.vts $27, $53, 0

        # ---------------- div + stores pipelined ----------------
        div.vs   $10, $30, $24, 1
        div.vs   $11, $31, $25, 1
        vreg.st  $10, $3, 4, 4, 0, 1, 0
        div.vs   $12, $32, $26, 1
        vreg.st  $11, $3, 4, 4, 0, 1, 1
        div.vs   $13, $33, $27, 1
        vreg.st  $12, $3, 4, 4, 0, 1, 2
        vreg.st  $13, $3, 4, 4, 0, 1, 3
