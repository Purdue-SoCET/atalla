module add_fp16_4_input_no_if #(
    ...
    input logic clk, 
    input logic nRST,
    input logic [MANTISSA_SIZE + EXPONENT_SIZE : 0] a, b, c, d,
    output logic [OUT_MANTISSA_SIZE + EXPONENT_SIZE : 0] out
);
    ...
    always_comb begin : stage1_logic
        ...
        a_daz = (a[14:10] == 0) ? {a[15], 15'd0} : a;
        b_daz = (b[14:10] == 0) ? {b[15], 15'd0} : b;
        c_daz = (c[14:10] == 0) ? {c[15], 15'd0} : c;
        d_daz = (d[14:10] == 0) ? {d[15], 15'd0} : d;
