...
module sysarr_4_input_fp_adder_no_if #(
    ...
    input logic clk, 
    input logic nRST,
    input logic [IN_MANTISSA_SIZE + IN_EXPONENT_SIZE : 0] a, b, c, d,
    output logic [MANTISSA_SIZE + EXPONENT_SIZE : 0] out
);
    ...
    always_comb begin : stage1_logic
        ...
        a_daz = (a[IN_MANTISSA_SIZE +: IN_EXPONENT_SIZE] == 0) ? {a[IN_EXPONENT_SIZE+IN_MANTISSA_SIZE], {(IN_EXPONENT_SIZE+IN_MANTISSA_SIZE){1'b0}}} : a;
        b_daz = (b[IN_MANTISSA_SIZE +: IN_EXPONENT_SIZE] == 0) ? {b[IN_EXPONENT_SIZE+IN_MANTISSA_SIZE], {(IN_EXPONENT_SIZE+IN_MANTISSA_SIZE){1'b0}}} : b;
        c_daz = (c[IN_MANTISSA_SIZE +: IN_EXPONENT_SIZE] == 0) ? {c[IN_EXPONENT_SIZE+IN_MANTISSA_SIZE], {(IN_EXPONENT_SIZE+IN_MANTISSA_SIZE){1'b0}}} : c;
        d_daz = (d[IN_MANTISSA_SIZE +: IN_EXPONENT_SIZE] == 0) ? {d[IN_EXPONENT_SIZE+IN_MANTISSA_SIZE], {(IN_EXPONENT_SIZE+IN_MANTISSA_SIZE){1'b0}}}   : d;
