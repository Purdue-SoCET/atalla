module icache (
  ...
  caches_if.icache cif
    ...
    icache_frame [255:0] bank0_cache, n_bank0_cache;
    icache_frame [255:0] bank1_cache, n_bank1_cache;
    ...
    // Format: [31:13] Tag, [12:5] Index, [4] Bank, [3:0] Byte Offset
    logic [18:0] tag_b0, tag_b1;
    logic [7:0]  idx_b0, idx_b1; // Adjust index width based on cache size

    assign tag_b0 = addr_b0[31:13]; // Simplification: replace with your exact tag slice
    assign idx_b0 = addr_b0[12:5];  // Simplification: replace with your exact index slice
    
    assign tag_b1 = addr_b1[31:13];
    assign idx_b1 = addr_b1[12:5];
