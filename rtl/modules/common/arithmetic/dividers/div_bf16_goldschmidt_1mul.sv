...
module div_bf16_goldschmidt_1mul (
    ...
    assign is_same_mag = (divif.in.operand1[14:0] == divif.in.operand2[14:0]);
    assign is_div_by_one = (divif.in.operand2[14:0] == 15'h3F80);
        ...
        case (state)
            IDLE: begin
                ...
                if (divif.in.valid_in) begin
                    ...
                    next_exp = $signed({2'b0, divif.in.operand1[14:7]}) - $signed({2'b0, divif.in.operand2[14:7]}) + 10'sd127;
            ...
            SPECIAL: begin
                ...
                if (a_nan || b_nan || (a_inf && b_inf) || (a_zero && b_zero))
                    ...
                    next_res_out = {next_sign, divif.in.operand1[14:7], divif.in.operand1[6:0]};
                else
            ...
            ROUND: begin
                if (!(a_nan || b_nan || (a_inf && b_inf) || (a_zero && b_zero) || a_inf || b_zero || a_zero || b_inf)) begin
                    ...
                    true_exp_calc = res_exp + $signed({2'b0, reg_n[14:7]}) - 10'sd127;
