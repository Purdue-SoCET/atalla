`timescale 1ns/1ps
// BF16 -> FP32 multiplier (no rounding loss in mantissa)
// Last Modified: BF16 inputs, FP32 output for exact accumulation path. (myles querimit)
//
// Timing: comb > reg
// Submodule: wtm_bf 
//   Cycle 0 (comb): NaN/Inf detect, implicit bit, WTM 8b (comb), exponent add, normalize, sign calc, output mux
//   Cycle 1: output reg (result)
//   done (lat1_ready) goes high 1 cycle after start, same cycle result is registered
