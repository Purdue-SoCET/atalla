...
//
// lat: 1 cycle. a single pipeline register (pipeline_reg) splits the
// datapath in the middle: comb -> reg -> comb.
...
// Stage 2 output is combinational: fp_out is valid one cycle after the
// inputs, from pipeline_reg alone.
