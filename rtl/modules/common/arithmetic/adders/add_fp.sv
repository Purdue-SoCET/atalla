...
//
// Timing: comb > reg > comb > reg (2-cycle latency, stall-able)
// Submodule: normalize_fp
//   Cycle 1 (comb): DAZ flush, special-case detect, exponent compare, mantissa alignment, magnitude compare
//   Cycle 1: pipeline reg
//   Cycle 2 (comb): signed add/sub, normalization, rounding, FTZ/overflow
//   Cycle 2: output reg (fp_out)
//
// Parameters:
