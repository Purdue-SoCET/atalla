...
## Current progress
- As of 11/21 Friday - My convolution library works with variable input size, variable input channels, variable kernel size, variable stride, variable padding and no dilation. Updated conv intrinsic can be found here:
