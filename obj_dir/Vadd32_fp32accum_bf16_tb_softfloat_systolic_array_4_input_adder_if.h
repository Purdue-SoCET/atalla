...
class alignas(VL_CACHE_LINE_BYTES) Vadd32_fp32accum_bf16_tb_softfloat_systolic_array_4_input_adder_if final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vadd32_fp32accum_bf16_tb_softfloat_systolic_array_4_input_adder_if(Vadd32_fp32accum_bf16_tb_softfloat__Syms* symsp, const char* v__name);
