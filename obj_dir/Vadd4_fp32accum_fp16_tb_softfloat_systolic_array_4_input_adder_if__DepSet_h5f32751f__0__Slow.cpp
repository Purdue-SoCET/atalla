...
VL_ATTR_COLD void Vadd4_fp32accum_fp16_tb_softfloat_systolic_array_4_input_adder_if___ctor_var_reset(Vadd4_fp32accum_fp16_tb_softfloat_systolic_array_4_input_adder_if* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vadd4_fp32accum_fp16_tb_softfloat_systolic_array_4_input_adder_if___ctor_var_reset\n"); );
