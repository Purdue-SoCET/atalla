...
VL_ATTR_COLD void Vadd4_fp16_tb_softfloat___024root___ctor_var_reset(Vadd4_fp16_tb_softfloat___024root* vlSelf) {
    ...
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT____Vcellout__second_stage__sum_i = VL_RAND_RESET_I(13);
    ...
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__b_inv = VL_RAND_RESET_I(13);
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__c_inv = VL_RAND_RESET_I(13);
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__d_inv = VL_RAND_RESET_I(13);
    ...
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__s2 = VL_RAND_RESET_I(13);
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__c2 = VL_RAND_RESET_I(13);
    ...
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__magnitude_sum = VL_RAND_RESET_I(15);
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__second_stage__DOT__corrected_sum = VL_RAND_RESET_I(15);
    ...
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__third_stage__DOT__sum_reg = VL_RAND_RESET_I(14);
    ...
    vlSelf->add4_fp16_tb_softfloat__DOT__etchedfp4adder__DOT__third_stage__DOT__rounded_mantissa_internal = VL_RAND_RESET_I(11);
