...
void Vadd4_bf16_tb_softfloat___024root__trace_chg_0_sub_0(Vadd4_bf16_tb_softfloat___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[3U] 
        ...
        bufp->chgIData(oldp+69,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__x_mant),22);
        bufp->chgIData(oldp+70,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__y_shifted),22);
        bufp->chgIData(oldp+71,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__m_shifted),22);
        bufp->chgIData(oldp+72,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__n_shifted),22);
        bufp->chgIData(oldp+73,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__y_mant_base),22);
        bufp->chgIData(oldp+74,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__m_mant_base),22);
        bufp->chgIData(oldp+75,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__n_mant_base),22);
        ...
        bufp->chgBit(oldp+84,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__any_pos_inf));
        bufp->chgBit(oldp+85,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__any_neg_inf));
        bufp->chgSData(oldp+86,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__special_result),16);
        bufp->chgIData(oldp+87,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__op_x),25);
        bufp->chgIData(oldp+88,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__op_y),25);
        bufp->chgIData(oldp+89,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__op_m),25);
        bufp->chgIData(oldp+90,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__op_n),25);
        bufp->chgIData(oldp+91,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__csa_s1),25);
        bufp->chgIData(oldp+92,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__csa_c1),25);
        bufp->chgIData(oldp+93,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__csa_s2),25);
        bufp->chgIData(oldp+94,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__csa_c2),25);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[4U]))) {
        bufp->chgSData(oldp+95,(vlSymsp->TOP__add4_bf16_tb_softfloat__DOT__add_if.out),16);
        bufp->chgCData(oldp+96,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st1_a_e),8);
        bufp->chgBit(oldp+97,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st1_a_s));
        ...
        bufp->chgIData(oldp+101,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st1_sum_vec),25);
        bufp->chgIData(oldp+102,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st1_carry_vec),25);
        bufp->chgCData(oldp+103,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st1_hot_ones),2);
        bufp->chgIData(oldp+104,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__raw_sum),26);
        bufp->chgIData(oldp+105,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__mag_sum),24);
        bufp->chgBit(oldp+106,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__res_sign));
        bufp->chgCData(oldp+107,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st2_exp_base),8);
        bufp->chgIData(oldp+108,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st2_sum_mag),24);
        bufp->chgSData(oldp+109,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st2_spec_res),16);
        bufp->chgBit(oldp+110,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st2_res_sign));
        bufp->chgBit(oldp+111,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st2_sticky));
        bufp->chgBit(oldp+112,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__st2_special));
        bufp->chgIData(oldp+113,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__lzd_scan),24);
        bufp->chgCData(oldp+114,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__lead_zeros),6);
        bufp->chgIData(oldp+115,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__norm_val),24);
        ...
        bufp->chgIData(oldp+125,(vlSelfRef.add4_bf16_tb_softfloat__DOT__etchedfp4adder__DOT__stage3_logic__DOT__unnamedblk1__DOT__i),32);
    }
