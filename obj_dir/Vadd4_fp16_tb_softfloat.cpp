...
std::unique_ptr<VerilatedTraceConfig> Vadd4_fp16_tb_softfloat::traceConfig() const {
...
void Vadd4_fp16_tb_softfloat___024root__trace_decl_types(VerilatedVcd* tracep);

void Vadd4_fp16_tb_softfloat___024root__trace_init_top(Vadd4_fp16_tb_softfloat___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD static void trace_init(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    Vadd4_fp16_tb_softfloat___024root__trace_decl_types(tracep);
    Vadd4_fp16_tb_softfloat___024root__trace_init_top(vlSelf, tracep);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vadd4_fp16_tb_softfloat::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedVcdC* const stfp = dynamic_cast<VerilatedVcdC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vadd4_fp16_tb_softfloat::trace()' called on non-VerilatedVcdC object;"
            " use --trace-fst with VerilatedFst object, and --trace-vcd with VerilatedVcd object");
    }
    stfp->spTrace()->addModel(this);
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP));
    Vadd4_fp16_tb_softfloat___024root__trace_register(&(vlSymsp->TOP), stfp->spTrace());
}
