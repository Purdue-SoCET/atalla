...
VL_INLINE_OPT void Vadd4_fp32accum_bf16_tb_softfloat___024root___nba_sequent__TOP__0(Vadd4_fp32accum_bf16_tb_softfloat___024root* vlSelf) {
    ...
    if (vlSelfRef.add4_fp32accum_bf16_tb_softfloat__DOT__tb_nrst) {
        ...
        vlSelfRef.add4_fp32accum_bf16_tb_softfloat__DOT__bf16adder__DOT__st2_spec_res = 0U;
        ...
        vlSelfRef.add4_fp32accum_bf16_tb_softfloat__DOT__bf16adder__DOT__st1_special_result = 0U;
    }
...
#endif
            VL_FATAL_MT("tb/unit/systolic_array/add4_fp32accum_bf16_tb_softfloat.sv", 9, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("tb/unit/systolic_array/add4_fp32accum_bf16_tb_softfloat.sv", 9, "", "Active region did not converge.");
            }
