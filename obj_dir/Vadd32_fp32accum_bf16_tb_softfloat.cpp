...
Vadd32_fp32accum_bf16_tb_softfloat::Vadd32_fp32accum_bf16_tb_softfloat(const char* _vcname__)
    : Vadd32_fp32accum_bf16_tb_softfloat(Verilated::threadContextp(), _vcname__)
{
}
...
Vadd32_fp32accum_bf16_tb_softfloat::~Vadd32_fp32accum_bf16_tb_softfloat() {
    delete vlSymsp;
}
...
#endif  // VL_DEBUG
void Vadd32_fp32accum_bf16_tb_softfloat___024root___eval_static(Vadd32_fp32accum_bf16_tb_softfloat___024root* vlSelf);
void Vadd32_fp32accum_bf16_tb_softfloat___024root___eval_initial(Vadd32_fp32accum_bf16_tb_softfloat___024root* vlSelf);
void Vadd32_fp32accum_bf16_tb_softfloat___024root___eval_settle(Vadd32_fp32accum_bf16_tb_softfloat___024root* vlSelf);
void Vadd32_fp32accum_bf16_tb_softfloat___024root___eval(Vadd32_fp32accum_bf16_tb_softfloat___024root* vlSelf);

void Vadd32_fp32accum_bf16_tb_softfloat::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vadd32_fp32accum_bf16_tb_softfloat::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vadd32_fp32accum_bf16_tb_softfloat___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
...
const char* Vadd32_fp32accum_bf16_tb_softfloat::name() const {
    return vlSymsp->name();
}
...
void Vadd32_fp32accum_bf16_tb_softfloat___024root___eval_final(Vadd32_fp32accum_bf16_tb_softfloat___024root* vlSelf);

VL_ATTR_COLD void Vadd32_fp32accum_bf16_tb_softfloat::final() {
    Vadd32_fp32accum_bf16_tb_softfloat___024root___eval_final(&(vlSymsp->TOP));
}
...
void Vadd32_fp32accum_bf16_tb_softfloat___024root__trace_decl_types(VerilatedVcd* tracep);

void Vadd32_fp32accum_bf16_tb_softfloat___024root__trace_init_top(Vadd32_fp32accum_bf16_tb_softfloat___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD void Vadd32_fp32accum_bf16_tb_softfloat::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedVcdC* const stfp = dynamic_cast<VerilatedVcdC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vadd32_fp32accum_bf16_tb_softfloat::trace()' called on non-VerilatedVcdC object;"
