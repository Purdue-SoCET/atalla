...
REM
REM Generated by Vivado on Sun Nov 02 15:50:29 -0500 2025
...
echo "xvlog --incr --relax -L uvm -L uvm -prj lockup_free_cache_vlog.prj"
call xvlog  --incr --relax -L uvm -L uvm -prj lockup_free_cache_vlog.prj -log xvlog.log
