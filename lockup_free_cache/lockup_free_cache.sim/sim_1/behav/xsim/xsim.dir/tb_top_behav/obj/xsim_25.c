...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x507090)) ;
...
extern "C" {
	...
	extern void subprog_m_b39d864d_556ead11_2381(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 418032, 176, 1005896) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_b39d864d_556ead11_2381), IP) ;
