...
add wave -noupdate -expand -group FSM /vexp_tb/dut/x_div_ln2_abs
...
add wave -noupdate -expand -group FSM /vexp_tb/dut/BF16_FSM/q_signed
add wave -noupdate -expand -group FSM /vexp_tb/dut/BF16_FSM/q
add wave -noupdate -expand -group FSM /vexp_tb/dut/BF16_FSM/int_part_reg
...
WaveRestoreCursors {{Cursor 1} {840783 ps} 0}
...
update
WaveRestoreZoom {760567 ps} {811632 ps}
