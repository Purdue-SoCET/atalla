...
# Same as build_conv but Phase 4 double-buffers rows ($4,$5 vs $14,$15); prefetch next while gemm on current.
...
def main():
    ...
    ap.add_argument("-o", "--output", type=Path, default=Path("conv_sa_pipelined.in"))
    ...
    asm = make_conv_sa_pipelined_asm(
        M=M,
        K_flat=K_flat,
        K_out=K,
        cfg_base=CFG_BASE,
    ...
    # ifmap/weights same as build_conv (ifmap 0,1,...; weights 100,101,...)
