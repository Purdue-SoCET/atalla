`ifndef lfc_store_miss_seq_SV
`define lfc_store_miss_seq_SV

import uvm_pkg::*;
`include "uvm_macros.svh"
`include "lfc_cpu_transaction.sv"

class lfc_store_miss_seq extends uvm_sequence#(lfc_cpu_transaction);
  `uvm_object_utils(lfc_store_miss_seq)

  function new(string name = "lfc_store_miss_seq");
    super.new(name);
  endfunction
  ...
  virtual task body();
    ...
    `uvm_info(get_type_name(), "Starting basic lfc_store_miss_seq...", UVM_MEDIUM)
