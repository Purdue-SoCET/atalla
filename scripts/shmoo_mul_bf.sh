...
SDC_FILE="$FLOWKIT_DIR/scripts/constraints/mul_bf.sdc"
REPORTS_SRC="$FLOWKIT_DIR/reports"
QOR_FILE="$REPORTS_SRC/syn_opt/qor.rpt"
DEST_BASE="$HOME/atalla/reports/mul_bf_45nm"
MD_FILE="$FLOWKIT_DIR/rpt_mul_bf.md"
