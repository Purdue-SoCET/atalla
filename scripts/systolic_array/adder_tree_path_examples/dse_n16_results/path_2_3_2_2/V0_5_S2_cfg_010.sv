...
module V0_5_S2_cfg_010 #(parameter int WIDTH = 32) (
    ...
    // --- Stage 1: 3-way Reduction ---
    logic [EXT_WIDTH-1:0] s1_g0_c = s0_g0_r + s0_g1_r + s0_g2_r;
    logic [EXT_WIDTH-1:0] s1_g1_c = s0_g3_r + s0_g4_r + s0_g5_r;
    logic [EXT_WIDTH-1:0] s1_g2_c = s0_g6_r + s0_g7_r;
    ...
    logic [EXT_WIDTH-1:0] s2_g1_r = s1_g2_r;
