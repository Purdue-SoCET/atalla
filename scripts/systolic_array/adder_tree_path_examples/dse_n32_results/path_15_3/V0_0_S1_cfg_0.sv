...
module V0_0_S1_cfg_0 #(parameter int WIDTH = 32) (
    ...
    logic [EXT_WIDTH-1:0] s0_g1_c = cur[15] + cur[16] + cur[17] + cur[18] + cur[19] + cur[20] + cur[21] + cur[22] + cur[23] + cur[24] + cur[25] + cur[26] + cur[27] + cur[28] + cur[29];
    logic [EXT_WIDTH-1:0] s0_g2_c = cur[30] + cur[31];
