`timescale 1ns/1ps
module add32_tree_16_2_pipe_0_lat1_var0_0 #(parameter int WIDTH = 32) (
    ...
    assign s0_g0_c = cur[0] + cur[1] + cur[2] + cur[3] + cur[4] + cur[5] + cur[6] + cur[7] + cur[8] + cur[9] + cur[10] + cur[11] + cur[12] + cur[13] + cur[14] + cur[15];
    logic [EXT_WIDTH-1:0] s0_g1_c;
    assign s0_g1_c = cur[16] + cur[17] + cur[18] + cur[19] + cur[20] + cur[21] + cur[22] + cur[23] + cur[24] + cur[25] + cur[26] + cur[27] + cur[28] + cur[29] + cur[30] + cur[31];
