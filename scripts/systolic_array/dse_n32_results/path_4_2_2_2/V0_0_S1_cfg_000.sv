...
module V0_0_S1_cfg_000 #(parameter int WIDTH = 32) (
    ...
    logic [EXT_WIDTH-1:0] s0_g4_c = cur[16] + cur[17] + cur[18] + cur[19];
    logic [EXT_WIDTH-1:0] s0_g5_c = cur[20] + cur[21] + cur[22] + cur[23];
    logic [EXT_WIDTH-1:0] s0_g6_c = cur[24] + cur[25] + cur[26] + cur[27];
    logic [EXT_WIDTH-1:0] s0_g7_c = cur[28] + cur[29] + cur[30] + cur[31];
