`timescale 1ns/1ps
module add32_tree_2_2_2_2_2_pipe_0000_lat1_var0_0 #(parameter int WIDTH = 32) (
    ...
    assign s0_g8_r = s0_g8_c;
    assign s0_g9_r = s0_g9_c;
    assign s0_g10_r = s0_g10_c;
    assign s0_g11_r = s0_g11_c;
    assign s0_g12_r = s0_g12_c;
    assign s0_g13_r = s0_g13_c;
    assign s0_g14_r = s0_g14_c;
    assign s0_g15_r = s0_g15_c;
    ...
    logic [EXT_WIDTH-1:0] s1_g4_c;
    assign s1_g4_c = s0_g8_r + s0_g9_r;
    logic [EXT_WIDTH-1:0] s1_g5_c;
    assign s1_g5_c = s0_g10_r + s0_g11_r;
    logic [EXT_WIDTH-1:0] s1_g6_c;
    assign s1_g6_c = s0_g12_r + s0_g13_r;
    logic [EXT_WIDTH-1:0] s1_g7_c;
    assign s1_g7_c = s0_g14_r + s0_g15_r;
    ...
    assign s1_g2_r = s1_g2_c;
    assign s1_g3_r = s1_g3_c;
    assign s1_g4_r = s1_g4_c;
    assign s1_g5_r = s1_g5_c;
    assign s1_g6_r = s1_g6_c;
    assign s1_g7_r = s1_g7_c;
    ...
    logic [EXT_WIDTH-1:0] s2_g2_c;
    assign s2_g2_c = s1_g4_r + s1_g5_r;
    logic [EXT_WIDTH-1:0] s2_g3_c;
    assign s2_g3_c = s1_g6_r + s1_g7_r;
    ...
    assign s2_g2_r = s2_g2_c;
    assign s2_g3_r = s2_g3_c;

    // --- Stage 3: 2-way Reduction ---
    logic [EXT_WIDTH-1:0] s3_g0_c;
    assign s3_g0_c = s2_g0_r + s2_g1_r;
    logic [EXT_WIDTH-1:0] s3_g1_c;
    assign s3_g1_c = s2_g2_r + s2_g3_r;
    logic [EXT_WIDTH-1:0] s3_g0_r;
    logic [EXT_WIDTH-1:0] s3_g1_r;
    assign s3_g0_r = s3_g0_c;
    assign s3_g1_r = s3_g1_c;

    // --- Stage 4: 2-way Reduction ---
    logic [EXT_WIDTH-1:0] s4_g0_c;
    assign s4_g0_c = s3_g0_r + s3_g1_r;
    logic [EXT_WIDTH-1:0] s4_g0_r;
    assign s4_g0_r = s4_g0_c;
