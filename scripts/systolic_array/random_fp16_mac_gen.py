...
"python3 scripts/systolic_array/random_fp16_mac_gen.py 100000"
...
def fp16_mul_daz_ftz(a_bits, b_bits):
...
def fp16_add_daz_ftz(a_bits, b_bits):
...
def fp16_mac(a_bits, b_bits, c_bits):
    ...
    prod_bits = fp16_mul_daz_ftz(a_bits, b_bits)
    result_bits = fp16_add_daz_ftz(prod_bits, c_bits)
