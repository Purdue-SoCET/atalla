...
module sysarr_32_input_fp_aligner #(
    ...
    always_ff @(posedge clk or negedge nRST) begin
        if (!nRST) begin
            ...
            max_l0_n8_r <= max_l0_n8_c;
            max_l0_n9_r <= max_l0_n9_c;
            max_l0_n10_r <= max_l0_n10_c;
            max_l0_n11_r <= max_l0_n11_c;
            max_l0_n12_r <= max_l0_n12_c;
            max_l0_n13_r <= max_l0_n13_c;
            max_l0_n14_r <= max_l0_n14_c;
            max_l0_n15_r <= max_l0_n15_c;
        end
    end
    ...
    logic [EXPONENT_SIZE-1:0] max_l0_n8_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n9_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n10_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n11_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n12_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n13_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n14_r;
    logic [EXPONENT_SIZE-1:0] max_l0_n15_r;
    ...
    assign max_l1_n4_c = (max_l0_n8_r > max_l0_n9_r) ? max_l0_n8_r : max_l0_n9_r;
    logic [EXPONENT_SIZE-1:0] max_l1_n5_c;
    assign max_l1_n5_c = (max_l0_n10_r > max_l0_n11_r) ? max_l0_n10_r : max_l0_n11_r;
    logic [EXPONENT_SIZE-1:0] max_l1_n6_c;
    assign max_l1_n6_c = (max_l0_n12_r > max_l0_n13_r) ? max_l0_n12_r : max_l0_n13_r;
    logic [EXPONENT_SIZE-1:0] max_l1_n7_c;
    assign max_l1_n7_c = (max_l0_n14_r > max_l0_n15_r) ? max_l0_n14_r : max_l0_n15_r;
    ...
    always_ff @(posedge clk or negedge nRST) begin
        if (!nRST) begin
            ...
            max_l2_n2_r <= max_l2_n2_c;
            max_l2_n3_r <= max_l2_n3_c;
        end
    end
    logic [EXPONENT_SIZE-1:0] max_l2_n0_r;
    logic [EXPONENT_SIZE-1:0] max_l2_n1_r;
    logic [EXPONENT_SIZE-1:0] max_l2_n2_r;
    logic [EXPONENT_SIZE-1:0] max_l2_n3_r;
    ...
    assign max_l3_n1_c = (max_l2_n2_r > max_l2_n3_r) ? max_l2_n2_r : max_l2_n3_r;
    ...
    logic sign_dly  [0:2][0:31];
    logic [EXPONENT_SIZE-1:0] exp_dly   [0:2][0:31];
    logic [NEW_MANT_WIDTH-1:0] mant_dly [0:2][0:31];
    ...
    logic [NEW_MANT_WIDTH-1:0] shifted_mant_c [0:31];
    logic sticky_bit [0:31];

    always_comb begin
        for (int i = 0; i < 32; i++) begin
            shift_amt[i] = max_l4_n0_c - exp_dly[2][i];
