// Auto-generated Adder Tree | Configuration: 10 (1=Reg, 0=Comb)
// Number of Inputs: 64 | Radix: 4
module adder_n64_a4_cfg_10 #(
    ...
    logic [EXT_WIDTH-1:0] l0_reg_8;
    logic [EXT_WIDTH-1:0] l0_reg_9;
    logic [EXT_WIDTH-1:0] l0_reg_10;
    logic [EXT_WIDTH-1:0] l0_reg_11;
    logic [EXT_WIDTH-1:0] l0_reg_12;
    logic [EXT_WIDTH-1:0] l0_reg_13;
    logic [EXT_WIDTH-1:0] l0_reg_14;
    logic [EXT_WIDTH-1:0] l0_reg_15;
    always_ff @(posedge clk or negedge nRST) begin
        if (!nRST) begin
            ...
            l0_reg_8 <= l0_g8_comb;
            l0_reg_9 <= l0_g9_comb;
            l0_reg_10 <= l0_g10_comb;
            l0_reg_11 <= l0_g11_comb;
            l0_reg_12 <= l0_g12_comb;
            l0_reg_13 <= l0_g13_comb;
            l0_reg_14 <= l0_g14_comb;
            l0_reg_15 <= l0_g15_comb;
        end
    end
    ...
    logic [EXT_WIDTH-1:0] l1_g2_comb = l0_reg_8 + l0_reg_9 + l0_reg_10 + l0_reg_11;
    logic [EXT_WIDTH-1:0] l1_g3_comb = l0_reg_12 + l0_reg_13 + l0_reg_14 + l0_reg_15;
    // --- Level 2 reduction ---
    logic [EXT_WIDTH-1:0] l2_g0_comb = l1_g0_comb + l1_g1_comb + l1_g2_comb + l1_g3_comb;
