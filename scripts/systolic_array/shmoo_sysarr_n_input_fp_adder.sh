# ================================================
# shmoo script for n input fp adder 
# Made by: Mixuan Pan 
# Last modified: 3/10, 2026 (Tarakanath Peddi)
#
...
SDC_FILE="$FLOWKIT_DIR/scripts/constraints/8inputadder.sdc"
REPORTS_SRC="$FLOWKIT_DIR/reports"
QOR_FILE="$REPORTS_SRC/syn_opt/qor.rpt"
DEST_BASE="$HOME/atalla/reports/sysarr_8_input_fp_adder"
