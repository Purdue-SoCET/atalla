/*
 * 2-input FP16 adder test vector generator using Berkeley SoftFloat.
 *
 * Computes: result = a + b using IEEE-754 compliant softfloat,
 * with configurable DAZ (Denormals-Are-Zero) and FTZ (Flush-To-Zero).
 *
 * Build:
 ...
 *
 * Usage:
 *   ./gen_testfloat2 [options] > testfloat_cases_2.csv
 *
 *   Options:
...
int main(int argc, char *argv[]) {
    ...
    for (i = 0; i < n; i++) {
        ...
        uint16_t result = hw_add_f16(a, b);
