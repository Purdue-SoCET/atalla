# --- Configuration ---
set TB_FILE ./tb/unit/ddr_cntrl/testbench/refresh_counter_tb.sv
set TB_TOP  refresh_counter_tb
...
do ./waves/refresh_counter_tb.do

run -all

# --- Coverage Report ---
file mkdir ./reports/ddr_cntrl
coverage save -onexit ./reports/ddr_cntrl/refresh_counter_coverage.ucdb
coverage report -detail -output ./reports/ddr_cntrl/refresh_counter_coverage.txt
