...
add wave -noupdate -expand -group {DUT outputs} -expand /tb_top/DUT/ram_mem_REN
add wave -noupdate -expand -group {DUT outputs} /tb_top/DUT/ram_mem_WEN
add wave -noupdate -expand -group {DUT outputs} -expand /tb_top/DUT/ram_mem_addr
...
add wave -noupdate /uvm_root/uvm_test_top/env/ram_active_agent/mon/has_run_once
add wave -noupdate -expand /uvm_root/uvm_test_top/env/ram_active_agent/mon/prev_tx
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {390 ns} 1} {{Cursor 2} {530 ns} 1} {{Cursor 3} {670 ns} 1} {{Cursor 4} {809 ns} 0}
