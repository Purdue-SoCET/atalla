...
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_hold_elem
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_hold_result
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_hold_valid
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_hold_vd
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_meta_in
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_meta_out
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_seq_in
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_seq_out
add wave -noupdate -expand -group {Mul Pipeline} /lane_tb/dut/mul_sync_ready
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {6036492483 ps} 0}
...
update
WaveRestoreZoom {6036423393 ps} {6038151401 ps}
