...
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/ADD_4_INPUT_LATENCY
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/MUL_LATENCY
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/PIPELINE_DEPTH
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/NUM_GROUPS
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/OUT_START
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/IN_CNTR_W
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/OUT_CNTR_W
add wave -noupdate -expand -group {Control Unit} -group {Control Unit Parameters} /TPU_top_tb/DUT/control_unit/TOTAL_DELAY
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/in_buffer_empty
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/vector_in
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/ready_out
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/rdone
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/vector_done
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/in_rd_en
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/out_wr_en
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/ready_in
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/out_rd_en
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/vector_out
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/vector_cnt
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/next_vector_cnt
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/credits
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/next_credits
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/group_en
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/next_group_en
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/in_cnt
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/next_in_cnt
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/next_out_wr_en
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/output_vector_counter
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/next_output_vector_counter
add wave -noupdate -expand -group {Control Unit} /TPU_top_tb/DUT/control_unit/shift_reg
...
add wave -noupdate -expand -group {Input Buffer} -group Parameters /TPU_top_tb/DUT/u_input_buffer/READ_LATENCY
add wave -noupdate -expand -group {Input Buffer} -group Parameters /TPU_top_tb/DUT/u_input_buffer/WRITE_LATENCY
add wave -noupdate -expand -group {Input Buffer} -group Parameters /TPU_top_tb/DUT/u_input_buffer/PTR_WIDTH
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/stall
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/wr_en
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/wr_data
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/rd_en
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/rd_data
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/rdone
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/lane0_empty
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/wr_ptr
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/next_wr_ptr
add wave -noupdate -expand -group {Input Buffer} /TPU_top_tb/DUT/u_input_buffer/rd_ptr
...
add wave -noupdate -expand -group {Output Buffer} -group {Output Buffer Parameter} /TPU_top_tb/DUT/genblk4/u_output_buffer/READ_LATENCY
add wave -noupdate -expand -group {Output Buffer} -group {Output Buffer Parameter} /TPU_top_tb/DUT/genblk4/u_output_buffer/WRITE_LATENCY
add wave -noupdate -expand -group {Output Buffer} -group {Output Buffer Parameter} /TPU_top_tb/DUT/genblk4/u_output_buffer/PTR_WIDTH
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/stall
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/rd_en
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/wr_data
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/wr_en
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/rd_data
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/vector_done
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/rdone
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/rd_ptr
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/next_rd_ptr
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/stall_rd_ptr
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/next_stall_rd_ptr
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/rd_addr
add wave -noupdate -expand -group {Output Buffer} /TPU_top_tb/DUT/genblk4/u_output_buffer/wr_ptr
